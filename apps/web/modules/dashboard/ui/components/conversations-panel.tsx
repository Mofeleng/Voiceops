...
export const ConversationsPanel = () => {
    ...
    return (
        <div className="flex w-full h-full flex-col bg-background text-sidebar-forground">
                        ...
                        { conversations.results.map((conversation) => {
                            ...
                            return (
                                <Link 
                                    ...
                                    className={cn("relative flex cursor-pointer items-start gap-3 border-b p-4 py-5 text-small leading-tight hover:bg-accent hover:text-accent-foreground", pathname === `/conversations/${conversation._id}` && "bg-accent text-accent-foreground")}
                                >
                                <div className={cn("-translate-y-1/2 absolute top-1/2 left-0 h-[64] w-1 rounded-r-full bg-neutral-200 opacity-0 transition-opacity", pathname === `/conversations/${conversation._id}` && "opacity-100")} />
                                <DicebearAvatar
